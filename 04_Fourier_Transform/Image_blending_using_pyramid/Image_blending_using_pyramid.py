...
def collapse(lapl_pyr):
    ...
    for i in range(len(lapl_pyr) - 1, 0, -1):
        ...
        # (2) Add (1) to the next level layer
        tmp = lap + lapb
        lapl_pyr.pop()
        lapl_pyr.pop()
        lapl_pyr.append(tmp)
...
if __name__ == '__main__':
    ...
    print('Split each image to RGB channels')
    ...
    print('Build a Laplacian pyramid')
    ...
    print('Collaplse the Laplacian pyramid')
    ...
    print('Get the final blended image')
